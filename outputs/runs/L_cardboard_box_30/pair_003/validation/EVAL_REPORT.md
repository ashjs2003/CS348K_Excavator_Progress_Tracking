...
|--------|------------------|-------------------------------|-------------------------|---------------------|-------------------|
| Classic stereo (OpenCV) | Low (2.0%) | 1.02 m — **Unreliable for this check** | **No** — too little overlap | 0.0% | 20.9 |
| DA-V2 scaled to all valid OpenCV depth | High (100.0%) | 45.4 cm — **Poor** | Yes | 0.0% | n/a (not run) |
| DA-V2 scaled using OpenCV pixels at manual GT distances | High (100.0%) | 4.5 cm — **Good** | Yes | 13.5% | n/a (not run) |
...
- **LiDAR points compared:** 5 of 129 visible to the camera (3.9% association rate).
...
- **LiDAR points compared:** 89 of 129 visible to the camera (69.0% association rate).
- **Within 5 cm of laser:** 0.0% of compared points.
...
- **LiDAR points compared:** 89 of 129 visible to the camera (69.0% association rate).
- **Within 5 cm of laser:** 52.8% of compared points.
...
- **OpenCV vs DA-V2:** typical depth difference 36.5 cm where both have data (18,885 pixels).
- **OpenCV vs DA-V2 gt:** typical depth difference 43.8 cm where both have data (18,885 pixels).
- **DA-V2 vs DA-V2 gt:** typical depth difference 38.8 cm where both have data (921,600 pixels).
- **All methods together:** typical disagreement 22.5 cm (see heatmap below).
...
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/chart_scorecard.png` — green/yellow/red at-a-glance table
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/chart_coverage_and_accuracy.png` — side-by-side bar charts
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/chart_ray_error_histogram.png` — laser error distribution
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/chart_error_vs_range.png` — |ΔZ| vs LiDAR range (median/p90 per bin)
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/chart_photometric.png` — stereo consistency (if Foundation/OpenCV run)

**From evaluation (`06`):**
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/consensus_depth_std.png` — σ(Z) heatmap; caption in `evaluation_summary.json` → `consensus_map.caption`
- `/Users/yashasvinigopalan/Documents/College/Spring 2026/Visual Computing Systems/Final Project/CS348K_Excavator_Progress_Tracking/outputs/runs/L_cardboard_box_30/pair_003/validation/consensus_depth_std_on_rgb.png` — same on `depth/rgb1_rectified.png`

**Cross-method consensus:** Overlap 100.0% of frame; on overlap: median σ(Z)=19.6 cm, 36.6% of px with σ<15 cm.

...
from utils.project_config import calibration_file, camera_index, open_configured_camera

RGB1_CALIBRATION_FILE = calibration_file("left_intrinsics")
RGB1_CAMERA_INDEX = camera_index("L")
RGB2_CAMERA_INDEX = camera_index("R")
...
def main():
    ...
    cap1 = open_configured_camera(RGB1_CAMERA_INDEX, image_size)
    cap1.read()  # warm up RGB1 before opening RGB2 (helps some macOS USB setups)
    cap2 = open_configured_camera(RGB2_CAMERA_INDEX, image_size)
    cap2.read()

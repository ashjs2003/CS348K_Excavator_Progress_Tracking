...
OUT_FILE = Path("lidar_to_camera_extrinsics_optimized.npz")
EDGE_RESIDUAL_WEIGHT = 5.0

# OpenCV checkerboard object points use the first inner corner as (0, 0).
# For a 10x7-square board with 9x6 inner corners, the physical outer board
# edges are one square before the first inner corner and one square after the
# last inner corner.
